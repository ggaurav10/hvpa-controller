...
// +kubebuilder:webhook:path=/mutate-autoscaling-k8s-io-v1alpha1-hvpa,mutating=true,failurePolicy=fail,groups=hvpa.gardener.cloud,resources=hvpas,verbs=create;update,versions=v1alpha1,name=mhvpa.kb.io
...
// +kubebuilder:webhook:path=/validate-autoscaling-k8s-io-v1alpha1-hvpa,mutating=false,failurePolicy=fail,groups=hvpa.gardener.cloud,resources=hvpas,verbs=create;update,versions=v1alpha1,name=vhvpa.kb.io
